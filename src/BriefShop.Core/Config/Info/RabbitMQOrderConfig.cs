...
namespace BriefShop.Core
{
    ...
    /// </summary>
    [Serializable]
    public class RabbitMQOrderConfig : IConfig
    {
    ...
    {
        private Order _order;//订单信息
        private List<OrderProduct> _orderproductlist;//订单商品列表
        ...
        public List<OrderProduct> OrderProductList
        {
            ...
            set { _orderproductlist = value == null ? new List<OrderProduct>() : value; }
        }
    }
}
