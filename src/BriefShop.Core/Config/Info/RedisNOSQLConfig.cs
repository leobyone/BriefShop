...
namespace BriefShop.Core
{
    ...
    /// </summary>
    [Serializable]
    public class RedisNOSQLConfig : IConfig
    {
        private RedisConfig _user = null;//用户redis配置信息
        private RedisConfig _product = null;//商品redis配置信息
        private RedisConfig _promotion = null;//促销活动redis配置信息
        private RedisConfig _order = null;//订单redis配置信息

        /// <summary>
        /// 用户redis配置信息
        /// </summary>
        public RedisConfig User
        {
            get { return _user; }
            set { _user = value; }
        }
